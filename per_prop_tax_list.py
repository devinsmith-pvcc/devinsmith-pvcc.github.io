...
#   and produces a report which displays all the data and the tax due
#
...
#       -- Eligibility: Owner or leased vehicles which are predominately used for non-business purposes & have passenger license plates
